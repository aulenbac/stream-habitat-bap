...
# NRSA 0809 Benthic Macroinvertebrate MMI and Condition Class - https://www.epa.gov/sites/production/files/2015-09/bentcond.csv
# External Data: Benthic Reference Site Metrics, MMI, and Condition Class https://www.epa.gov/sites/production/files/2015-09/extbenthicrefcond.csv
user_url <- "https://www.epa.gov/sites/production/files/2015-09/bentcond.csv"

EPA_Data_URL <-"https://www.epa.gov/sites/production/files/2015-09/extbenthicrefcond.csv"

ld_download <- getURL(EPA_Data_URL)

large_data_2  <- tbl_df(read.csv (text=ld_download))
